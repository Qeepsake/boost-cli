...
export default class Component extends Command {
  static description = 'react-boost utility command creates a utility file with the utility template. Value for --directory flags will default to ./utils.'
  static hidden = false   // hide the command from help

  // custom usage string for help, overrides the default usage
  static usage = 'react-boost utility <component name> --directory <directory path>'
  ...
  async run() {
    ...
    createTemplate(directory, functionName, "utility");
  }
}
